        ...
        <div class="main-right">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                <form class="space-y-6" v-on:submit.prevent="submitForm">
                    ...
                    <div class="flex grid grid-cols-2 gap-4 items-center justify-center">
                        <div class="main-left">
                            <label class="py-4 px-6 bg-gray-600 text-white rounded-lg">
                                <input type="file" ref="file" @change="onFileChange">
                                Upload Avatar
                            </label>
                        </div>

                        <div id="preview" v-if="url" class="main-right ml-4 w-16 aspect-[1/1] rounded-full overflow-hidden">
                ...
                axios
                    ...
                    .then(response => {
                        if (response.data.message === 'Changes saved') {
                            this.toastStore.showToast(5000, 'The information was updated', 'bg-emerald-500')
