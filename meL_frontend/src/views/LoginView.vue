            ...
            if (this.errors.length === 0) {
                await axios
                    ...
                    .then(response => {
                        ...
                        this.toastStore.showToast(5000,`Welcome ${this.userStore.user.name}!`, 'bg-emerald-500')
                    })
                    .catch(error => {
                        console.log('error', error)

                        this.errors.push('The email or password is incorrect! Or the user in not activated!')
                    })
            }
